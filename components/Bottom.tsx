...
const BottomBox = () => {
    return (
        <>
            <div className="w-full flex flex-col justify-start items-start px-[50px] py-[60px] min-w-[1200px]">
                ...
                >
                    ...
                    <div className='flex justify-center items-start'>
                        ...
                        <div className='w-[170px] flex flex-col justify-start items-start'>
                            ...
                            <p className='bottom-notice !min-w-[164px] text-left'>마케팅 제휴, 입점, 대량 주문 문의</p>
                ...
                <div className='w-full mt-[14px] border-t-[1px] border-solid border-[#c7c7c7]'>
                    ...
                    <p className='absolute right-[42px] top-[64%] text-[11.4px]'>
                        KG 에스크로<br/>가입 사실 확인
                    </p>
                </div>
            </div>   
